...
class RetailersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create retailer" do
    assert_difference("Retailer.count") do
      post retailers_url, params: { retailer: { name: @retailer.name, schedule: @retailer.schedule } }
    end
  ...
  test "should update retailer" do
    patch retailer_url(@retailer), params: { retailer: { name: @retailer.name, schedule: @retailer.schedule } }
