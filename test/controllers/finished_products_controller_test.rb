...
class FinishedProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create finished_product" do
    assert_difference("FinishedProduct.count") do
      post finished_products_url, params: { finished_product: { boxes: @finished_product.boxes, pallet: @finished_product.pallet } }
    end
  ...
  test "should update finished_product" do
    patch finished_product_url(@finished_product), params: { finished_product: { boxes: @finished_product.boxes, pallet: @finished_product.pallet } }
